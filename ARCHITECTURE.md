...
| `stream` | yes | Streaming pipeline (HLS + DASH): `Source`, `Producer` (with inline `Container`, `Segment`, `Segments`, `Segment_info`, `Meta`, `Error`, `Kind`), `Hls`, `Dash`, `Selector`, `Source_container`, `Bmff`, `Bmff_builder`, `Ebml`, `Codec_string`, `Vod_mp4`, `Vod_webm`, `Webm_to_fmp4`, `Byte_range_source`, `Http_range`, `Iframe_stream` |
